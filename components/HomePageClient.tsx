          ...
          <div className="mb-6 mt-4 text-center sm:mb-8 sm:mt-6">
            ...
            <div className="mt-6 flex flex-wrap items-center justify-center gap-3 sm:mt-8">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-full border-2 border-cat/50 bg-cat-light/60 px-6 py-2.5 text-sm font-bold text-cat shadow-sm transition-all duration-200 hover:scale-[1.04] hover:shadow-md active:scale-[0.97] sm:px-8 sm:py-3 sm:text-base"
              >
                <svg viewBox="0 0 20 20" fill="currentColor" className="h-4 w-4">
